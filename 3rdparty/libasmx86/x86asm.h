...
public:
	...
	~x86asm(){free_asm_codes();}

	virtual	asm_code *encode(asm_insn *asm_insn, int _options, CPU_ADDR cur_address);
	...
	void set_imm_eval_proc(int (*pfn)(void *context, const char *s, uint64 &v), void *pContext);
